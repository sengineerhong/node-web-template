...
(function (global) {
    ...
    // function merge
    var merge = function () {
        var args = arguments; var target = args[0]; var key; var i;
            ...
            if (!byPass) {
                ...
                function doPartialCallback (useSafeMode, resResult) {
                    ...
                    if (useSafeMode) {
                        ...
                        // [LOGGER-DEV]
                        var str = '';
                        tmpResMap.forEach(function (v, k) {
                            str += '[' + k + ':object]';
                        });
                                ...
                                allDate.filter(function (eachDate) {
                                    ...
                                    if (existInfoDate.indexOf(eachDate) == -1) {
                                        ...
                                        var info = {
                                            date: eachDate,
                                            qOpt: reqOpt.qOpt,
                                            dateRage: reqOpt.dateRage,
                                            doneYn: 'n',
                                            infoCompact: eachDate + '|' + reqOpt.qOpt + '|' + reqOpt.dateRage
                                        };
