...
module.exports = (router) => {
    ...
    router.route('/acct/test1/grid').post(validation(rule.tab_acct_test1_grid), entirety.getAcctTest1Grid_reqOnce);
    router.route('/acct/test1/chart').post(validation(rule.tab_acct_test1_chart), entirety.getAcctTest1Chart);
    router.route('/acct/test2/grid').post(validation(rule.tab_acct_test2_grid), entirety.getAcctTest2Grid_reqOnce);
    router.route('/acct/test2/chart').post(validation(rule.tab_acct_test2_chart), entirety.getAcctTest2Chart);
    router.route('/acct/test2/pie').post(validation(rule.tab_acct_test2_pie), entirety.getAcctTest2Pie);
