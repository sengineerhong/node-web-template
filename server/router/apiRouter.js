...
module.exports = (router) => {
    ...
    // User
    // router.route('/all/loginpath/grid/day').post(validation(rule.tab_all_loginPath), entiretyC.getAllLoginPath);
    router.route('/all/dailysales/grid').post(validation(rule.tab_all_dailySales_grid), entiretyC.getAllLoginPath);
    // router.route('/all/dailysales/grid').post(validation(rule.tab_all_dailySales_grid), entiretyC.getAllDailySalesGrid);
    router.route('/all/dailysales/yoy').post(validation(rule.tab_all_dailySales_yoy), entiretyC.getAllDailySalesYoy);
